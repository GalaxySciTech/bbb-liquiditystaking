...
async function main() {
    console.log("Deploying XDC Liquid Staking (Spec v1.5)...");
    ...
    console.log("\nPost-deploy setup (Spec v1.5):");
    console.log("1. OperatorRegistry: registerOperator(admin, maxMasternodes), approveKYC(admin, kycHash)");
    console.log("2. Operators: whitelistCoinbase(coinbase) for each masternode");
    console.log("3. Users stake() -> bXDC. MasternodeManager auto-proposes when buffer healthy");
    console.log("4. Keeper: harvestRewards() collects from vaults, splits 90/7/3");
    console.log("5. Operators: RevenueDistributor.claimCommission()");
